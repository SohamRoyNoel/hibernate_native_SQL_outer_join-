...
public class ClientApp {
	...
	public static void main(String[] args) {
		...
		// String hql="select s.sname,c.clg_name from Student s left outer join College c on s.clg_id=c.clg_id";
		String hql="select s.sname,c.clg_name from Student s right outer join College c on s.clg_id=c.clg_id";
